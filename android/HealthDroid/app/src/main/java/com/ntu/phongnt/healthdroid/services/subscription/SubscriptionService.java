...
public class SubscriptionService extends IntentService {
    ...
    private static final String EXTRA_PARAM_USER =
            "com.ntu.phongnt.healthdroid.services.subscription.param.user";

    public SubscriptionService() {
        super("SubscriptionService");
    }

    public static void addSubscribedUser(Context context, String user) {
    ...
    public static void removeSubscribedUser(Context context, String user) {
        Intent intent = new Intent(context, SubscriptionService.class);
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if (ACTION_ADD_SUBSCRIBED_USER.equals(action)) {
